...
<?php if ($reservas): ?>
    <?php foreach ($reservas as $reserva): ?>
        <?php
            // 1) Obtener servicios adicionales para esta reserva
        ...
        <form method="POST" onsubmit="return confirm('¿Estás seguro de cancelar esta factura? Se eliminarán los datos.');">
